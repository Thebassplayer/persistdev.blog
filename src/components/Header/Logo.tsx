...
const Logo = ({ showNavBar }: LogoProps) => (
  <Link
    href={"/"}
  ...
  >
    <div
      className={cx(
        "ease mr-2 overflow-hidden rounded-full border border-solid border-dark shadow-[rgba(0,0,0,0)_0px_0px_8px]  shadow-light transition-all duration-300 dark:border-light lg:mr-4 lg:w-16",
        showNavBar ? "w-8" : "w-12",
      )}
    >
      <Image
