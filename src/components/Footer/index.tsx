...
const Footer = () => {
  return (
    <footer className="m-5 mt-8 flex flex-col items-center rounded-2xl bg-dark text-light dark:bg-accentDark/90 dark:text-dark sm:m-10 sm:mt-16">
      <h3 className="font-md mt-8 px-2 text-center text-2xl capitalize  dark:font-bold sm:mt-12 sm:text-3xl lg:text-4xl">
        Interesting Stories | Updates | Guides
      </h3>
      <SuscriptionForm />
      <SocialLinks />
      <div className="relative mt-8 flex w-full flex-col items-center justify-between border-t border-solid border-light px-8 py-6 font-medium dark:border-dark md:flex-row">
